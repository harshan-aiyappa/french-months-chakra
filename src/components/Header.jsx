  ...
  return (
    <Box as="header" textAlign="center" w="100%">
      <Flex justify="center" align="center" mb={4}>
        ...
        <Box textAlign="left">
          <Heading as="h1" size="md" color="slate.800">French Months</Heading>
          <Text fontSize="xs" color="slate.500">
            Powered by <Text as="span" color="brand.500" fontWeight="bold">Lingotran</Text>
          </Text>
        </Box>
      </Flex>
      <Text color="slate.600" mb={4} fontSize="sm">Speak the English translation of each French month</Text>
